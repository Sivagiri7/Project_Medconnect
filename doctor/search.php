...
<head>
	...
	<title>MedConnect || Search Appointment Detail</title>
					...
					<header class="widget-header">
						<form id="basic-form" method="post">
                                <div class="form-group">
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Mobile No"></div>
...
$sql="SELECT * from tblappointment where AppointmentNumber like '$sdata%' || Name like '$sdata%' || MobileNumber like '$sdata%' && Doctor=:docid";
