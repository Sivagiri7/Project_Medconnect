...
<html lang="en">
    <head>
        <title>Medical Appointment System || Home Page</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Search Appointment History by Mobile No</h2>
                            
                                <form role="form" method="post">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Mobile No">
                                        </div>
